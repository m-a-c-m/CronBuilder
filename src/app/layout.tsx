...
export const metadata: Metadata = {
  ...
  title: { default: "Cron Builder — Free Online Tool", template: "%s | Cron Builder" },
  ...
  openGraph: { title: "Cron Builder — Free Online Tool", description: "Build cron expressions visually. Natural language description and next 5 executions calculated.", url: SITE_URL, siteName: "Cron Builder — MACM", type: "website" },
  twitter: { card: "summary_large_image", title: "Cron Builder — Free Online Tool", description: "Build cron expressions visually. Natural language description and next 5 executions calculated." },
    ...
    <html lang="en">
      ...
      <body className="antialiased">
        ...
        <footer className="pb-8 text-center text-xs text-text-muted/40">
          ...
          {" · "}
          <a href="https://github.com/m-a-c-m/CronBuilder" target="_blank" rel="noopener noreferrer" className="text-text-muted/60 transition-colors hover:text-text-muted underline-offset-2 hover:underline">Open source</a>
        </footer>
      </body>
    </html>
  );
